 ...
 * # cd /path/to/client
 * # phpunit test/FriendConnectFcAuthTests.php
 */

require_once '__init__.php';
require_once 'online/OnlineTestSuite.php';

class FriendConnectFCAuthTests extends OnlineTestSuite {
  public $FCAUTH_TOKEN = 'ALhR-_vf_mt7HwpVBFq5gZmWfNLv4O3rkGGJVwPqBrizX1zmGhytyeQizgxie_4nyaff9PLmf0jHbKPokPKpkmbg_s0ZQfIZOQ';
  ...
  protected function getOsapi() {
    ...
    $auth = new osapiFCAuth($this->FCAUTH_TOKEN);
    return new osapi($provider, $auth);
  }

  public static function suite() {
    return new FriendConnectFCAuthTests();
  }
}
